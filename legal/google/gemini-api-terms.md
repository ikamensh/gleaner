...
You may only access the Services (or make API Clients available to users) within an [available region](</available_regions>). **You may use only Paid Services when making API Clients available to users in the European Economic Area, Switzerland, or the United Kingdom.**
...
**Note:** Previous versions of these Additional Terms are [archived here](</gemini-api/terms-archive>).
